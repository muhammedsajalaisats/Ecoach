...
// const checkDeviceAuthorization = async (deviceId: string): Promise<boolean> => {
//   try {
//     const { data, error } = await supabase
//       .from("Device_Details_DEL")
//       .select("device_id")
...
//       // Check if device is authorized
//       const isDeviceAuthorized = await checkDeviceAuthorization(currentDeviceInfo.deviceId);
//       if (!isDeviceAuthorized) {
//         throw new Error("Device not authorized. This device is not registered for data entry.");
//       }
