...
const coachNumbers = [
  ...
  "PC-31", "PC-32", "PC-33", "PC-34", "PC-35", "PC-36", "PC-37", "PC-38","PC-39","PC-40","PC-41","PC-42","PC-43","PC-44","PC-45","PC-46", "OT-01", "PC-100", "PC-200", "PC-201", "PC-202"
];
...
export function CoachReleasePage() {
  ...
  const confirmAction = async () => {
    ...
    try {
      ...
      // Auto-hide timeout removed — success message now stays until manually dismissed
    } catch (error) {
